          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground mt-1">
                 You’re expecting payments from {balances?.oweDetails?.youAreOwedBy?.length || 0} users
                </p>
              </CardContent>
            </Card>
              ...
              <CardContent>
                {balances?.oweDetails?.youOwe?.length > 0 ? (
                  <>
                    ...
                    <p className="text-xs text-muted-foreground mt-1">
                      You have dues with {balances?.oweDetails?.youOwe?.length || 0} users
                    </p>
                  </>
                ) : (
                  <>
